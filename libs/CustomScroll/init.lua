...
function module.new()
	...
	local Frame = script.SpringScrollingFrame:Clone() -- 프레임(창)
...
function module.init(Data)
	AdvancedTween = Data.AdvancedTween or AdvancedTween
	UserInputService = Data.UserInputService or UserInputService
	DefaultXMaxOverScroll = Data.DefaultXMaxOverScroll or DefaultXMaxOverScroll
	DefaultYMaxOverScroll = Data.DefaultYMaxOverScroll or DefaultYMaxOverScroll
end
